...
import { BookSpinnerComponent } from "../shared/components/book-spinner/book-spinner.component";

@Component({
  selector: 'app-book-details',
  standalone: true,
  imports: [RatingComponent, CurrencyPipe, DescriptionComponent, WishlistBtnComponent, CartBtnComponent, RelatedBooksComponent, BookSpinnerComponent],
